...
<h1>Administrace &gt; Schválené novinky</h1>
...
$vysledek_celk = mysql_query("select id from novinky where stav = 'v'");

$vysledek = mysql_query("select n.*, a.jmeno from novinky n, autori a where n.autor = a.id and stav = 'v' order by n.id desc limit $zaznam, $pocet",$db);
