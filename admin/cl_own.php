...
$vysledek_celk = mysql_query("select id from clanky where id_autor = '$_id'");

$vysledek = mysql_query("select c.id,c.nadpis,c.perex,r.rubrika,a.jmeno from clanky c, rubriky r, autori a where c.id_rubrika = r.id and c.id_autor = a.id and c.id_autor = '$_id' order by c.datum desc limit $zaznam, $pocet",$db);
